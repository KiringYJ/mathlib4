...
variable {α F : Type*} {m : SigmaAlgebra α} {μ : Measure α} [NormedAddCommGroup F]
...
variable {α : Type*} {m : SigmaAlgebra α} {p : ℝ≥0∞} {μ : Measure α}
...
variable {α E F 𝕜 : Type*} [RCLike 𝕜] {m : SigmaAlgebra α} {μ : Measure α} [NormedAddCommGroup E]
...
variable {α 𝕜 : Type*} [TopologicalSpace α] [SigmaAlgebra α] [BorelSpace α] [RCLike 𝕜]
