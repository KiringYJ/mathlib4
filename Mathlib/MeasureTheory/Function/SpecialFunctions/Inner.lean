...
@[fun_prop]
theorem Measurable.inner {_ : SigmaAlgebra α} [SigmaAlgebra E] [OpensSigmaAlgebra E]
    [SecondCountableTopology E] {f g : α → E} (hf : Measurable f)
    (hg : Measurable g) : Measurable fun t => ⟪f t, g t⟫ :=
  Continuous.measurable2 continuous_inner hf hg

@[fun_prop]
theorem Measurable.const_inner {_ : SigmaAlgebra α} [SigmaAlgebra E] [OpensSigmaAlgebra E]
    [SecondCountableTopology E] {c : E} {f : α → E} (hf : Measurable f) :
    Measurable fun t => ⟪c, f t⟫ :=
  Measurable.inner measurable_const hf

@[fun_prop]
theorem Measurable.inner_const {_ : SigmaAlgebra α} [SigmaAlgebra E] [OpensSigmaAlgebra E]
    [SecondCountableTopology E] {c : E} {f : α → E} (hf : Measurable f) :
    Measurable fun t => ⟪f t, c⟫ :=
  Measurable.inner hf measurable_const

@[fun_prop]
theorem AEMeasurable.inner {m : SigmaAlgebra α} [SigmaAlgebra E] [OpensSigmaAlgebra E]
...
@[fun_prop]
theorem AEMeasurable.const_inner {m : SigmaAlgebra α} [SigmaAlgebra E]
...
@[fun_prop]
theorem AEMeasurable.inner_const {m : SigmaAlgebra α} [SigmaAlgebra E]
    [OpensSigmaAlgebra E] [SecondCountableTopology E]
    {μ : MeasureTheory.Measure α} {f : α → E} {c : E} (hf : AEMeasurable f μ) :
