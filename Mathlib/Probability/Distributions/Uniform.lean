...
open TopologicalSpace MeasureTheory.Measure PMF ProbabilityTheory
...
lemma uniformPDF_eq_pdf {s : Set E} (hs : MeasurableSet s) (hu : pdf.IsUniform X s P μ) :
    (fun x ↦ uniformPDF s x μ) =ᵐ[μ] pdf X P μ :=
